(function(){
	...
	angular
		.module('escuela')
		.directive('gasto',directive);

	function directive(){
		var directive = {
        	link: link,
        	templateUrl: 'js/gasto/index.html',
        	restrict: 'EA',
        	scope:{
        		reg:'='
        	},
    	...
    	function controller(GastoFactory,error,$timeout,$window){
    		var vm=this;

			// Variables básicas
			var basicFactory=GastoFactory;
			vm.id=-1;
