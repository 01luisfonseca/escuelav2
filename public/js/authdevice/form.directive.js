(function(){
	...
	angular
		.module('escuela')
		.directive('formAuthdevice',directive);

	function directive(){
		var directive = {
        	link: link,
        	templateUrl: 'js/authdevice/form.html',
        	restrict: 'EA',
        	scope:{
        		existente: '='
        	},
    	...
    	function controller(AuthdeviceFactory,error){
    		var vm=this;

			// Variables básicas
			var basicFactory= AuthdeviceFactory;
			vm.ndts={};
			...
			function getData(id){
				return basicFactory.gDt(id).then(function(res){
					//console.log(res);
					vm.ndts=res.data;
					vm.ndts.estado=parseInt(vm.ndts.estado);
				});
			}
