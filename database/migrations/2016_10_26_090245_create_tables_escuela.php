...
class CreateTablesEscuela extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('alumnos', function (Blueprint $table) {
            ...
            $table->integer('niveles_has_anios_id');
            $table->float('pension',15,2);
            $table->mediumText('descripcion_pen');
            $table->float('matricula',15,2);
        ...
        Schema::create('pago_salario', function (Blueprint $table) {
            ...
            $table->integer('empleados_id');
            $table->float('salario_pagado',15,2);
            $table->float('auxmovil',15,2);
            $table->float('eps_empleado',15,2);
            $table->float('eps_empresa',15,2);
            $table->float('pension_empleado',15,2);
            $table->float('pension_empresa',15,2);
            $table->float('arl_empresa',15,2);
            $table->float('descuento',15,2);
            $table->mediumText('descripcion_desc');
            $table->float('bonificacion',15,2);
